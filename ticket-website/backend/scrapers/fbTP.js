...
const url = "https://www.tickpick.com/buy-arizona-cardinals-vs-green-bay-packers-(date-tbd)-tickets-state-farm-stadium-8-10-25-3am/6978045/?qty=2-false";
const outputFile = "fb_tp_tbd8.txt";
const gameDate = "tbd8";
...
const checkDatabase = () => {
    return new Promise((resolve, reject) => {
        db.all(
            `SELECT * FROM ticketsfb WHERE source = ? AND date = ? AND home_team = ?`,
