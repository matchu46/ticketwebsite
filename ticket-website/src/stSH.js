...
const url = "https://www.stubhub.com/phoenix-suns-phoenix-tickets-3-17-2025/event/154770115/?quantity=2";
const outputFile = "sun_sh_03_17.txt";
    ...
    const collectTickets = async () => {
        ...
        for (const ticketElement of ticketElements) {
            try {
                ...
                const ticketUrl = `https://www.stubhub.com/phoenix-suns-phoenix-tickets-3-17-2025/event/154770115/?quantity=2&listingId=${listingId}`;
